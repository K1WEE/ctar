      ...
      <div class="bg-brand-card backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-8 w-full max-w-md relative overflow-hidden">
        ...
        <div class="text-center mb-8 relative z-10">
          <div class="w-16 h-16 bg-brand-dark rounded-2xl flex items-center justify-center mx-auto mb-4 border border-white/10 shadow-lg">
            <i class="fa-solid fa-user-plus text-3xl text-emerald-400"></i>
          </div>
          <h1 class="text-3xl font-bold text-white tracking-tight mb-2">Create Account</h1>
          <p class="text-slate-400">Join CTAR platform</p>
        </div>
        ...
        <form (ngSubmit)="onSubmit()" class="space-y-4 relative z-10">
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input 
                ...
                name="firstName"
                required
                class="w-full px-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-white placeholder-slate-500 outline-none"
                placeholder="John">
            </div>
            <div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input 
                ...
                name="email"
                required
                class="w-full pl-10 pr-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-white placeholder-slate-500 outline-none"
          ...
          <button 
            type="submit" 
            [disabled]="loading"
            class="w-full bg-emerald-500 hover:bg-emerald-400 text-white font-medium py-3 rounded-xl transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_25px_rgba(16,185,129,0.5)] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center mt-2">
        ...
        <div class="mt-6 text-center text-sm text-slate-400 relative z-10">
          ...
          <a routerLink="/login" class="text-emerald-400 hover:text-white font-medium transition-colors">Sign In</a>
        </div>
      </div>
    </div>
  `
